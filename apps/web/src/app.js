...
import { ApiRequestError, api, apiUrl, setAccessToken, setUnauthorizedHandler, } from './lib/api.ts';
      ...
      <QueryClientProvider client={queryClient}>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/passport/print/:scope/:id/:period" element={<Suspense fallback={<LoadingState />}>
                  <PassportPrint />
                </Suspense>}/>

            <Route path="/login" element={<Suspense fallback={<LoadingState />}>
                  <LoginPage />
                </Suspense>}/>
...
function NotFound() {
    return (<div className="flex min-h-64 flex-col items-center justify-center gap-2 text-center">
