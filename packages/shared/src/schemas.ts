...
const count = (max = 1_000_000) =>
  z.coerce.number().int('Butun son bo‘lishi kerak').nonnegative('Manfiy son bo‘lishi mumkin emas').max(max).default(0);
...
export type EnergyBalancePatch = z.infer<typeof energyBalancePatchSchema>;
...
export type TpStatus = z.infer<typeof tpStatusSchema>;
...
export type TpReading = z.infer<typeof tpReadingSchema>;
...
export type NetworkDefect = z.infer<typeof networkDefectSchema>;
...
export type DebtTopEntry = z.infer<typeof debtTopEntrySchema>;
...
export type TpUpsert = z.infer<typeof tpUpsertSchema>;
