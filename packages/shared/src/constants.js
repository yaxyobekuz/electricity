 ...
 */
// ─── Rollar ──────────────────────────────────────────────────────────────────
export const ROLES = ['mfy_operator', 'elektroset_manager', 'hokimiyat_viewer', 'admin'];
export const ROLE_LABEL_UZ = {
...
export const WRITE_ROLES = ['mfy_operator', 'elektroset_manager', 'admin'];
/** Submission tasdiqlash huquqiga ega rollar. */
export const APPROVE_ROLES = ['elektroset_manager', 'admin'];
// ─── Submission workflow ─────────────────────────────────────────────────────
...
export const SUBMISSION_STATUS_LABEL_UZ = {
    draft: 'Qoralama',
...
export const RAG_STATUSES = ['good', 'warning', 'serious', 'critical'];
export const RAG_LABEL_UZ = {
    good: 'Yaxshi',
    warning: 'Diqqat',
    serious: 'Jiddiy',
    critical: 'Tanqidiy',
...
export const RAG_MULTIPLIERS = { warning: 1.0, serious: 1.25, critical: 1.6 };
export function ragByStandard(actual, standard) {
    if (!Number.isFinite(standard) || standard <= 0)
        return 'good';
    const ratio = actual / standard;
    if (ratio <= RAG_MULTIPLIERS.warning)
        return 'good';
    if (ratio <= RAG_MULTIPLIERS.serious)
        return 'warning';
    if (ratio <= RAG_MULTIPLIERS.critical)
        return 'serious';
    return 'critical';
}
// ─── TP holati ───────────────────────────────────────────────────────────────
export const TP_CONDITIONS = ['GOOD', 'ATTENTION', 'OVERLOAD', 'FAULT'];
export const TP_CONDITION_LABEL_UZ = {
    GOOD: 'Yaxshi',
...
export const WORK_TYPE_LABEL_UZ = {
...
export const WORK_UNIT_BY_TYPE = {
...
export const WORK_STATUSES = ['PLANNED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED'];
export const WORK_STATUS_LABEL_UZ = {
    PLANNED: 'Reja',
...
// ─── Dalolatnoma ─────────────────────────────────────────────────────────────
export const VIOLATION_STATUSES = ['DRAFT', 'ISSUED', 'PAID', 'COURT', 'CLOSED'];
export const VIOLATION_STATUS_LABEL_UZ = {
    DRAFT: 'Qoralama',
    ISSUED: 'Berilgan',
    PAID: 'To‘langan',
    COURT: 'Sudda',
...
export const CONSUMER_CATEGORIES = ['POPULATION', 'LEGAL', 'BUDGET'];
export const CONSUMER_CATEGORY_LABEL_UZ = {
    POPULATION: 'Aholi',
    LEGAL: 'Yuridik',
 ...
 */
export function balanceTolerance(kwhIn) {
    return Math.max(1, 0.005 * kwhIn);
}
// ─── Davr yordamchilari ──────────────────────────────────────────────────────
/** `YYYY-MM` → oyning birinchi kuni `YYYY-MM-01`. */
export function periodToMonthStart(period) {
    return `${period}-01`;
}
/** `YYYY-MM-DD` yoki `Date` → `YYYY-MM`. */
export function toPeriod(d) {
